...
public class AchieveMgr : IUIModule
{
    ...
    public void Init(Transform _achievePanelTr, AchieveItem _achieveItem)
    {
        ...
        m_AchieveInfoPanelTransform = m_AchivevePanelTransform.Find("InfoPanel");
    ...
    {   
        ...
        Text text_title = m_AchieveInfoPanelTransform.Find("top/Text_title").GetComponent<Text>();
        Text Text_attr = m_AchieveInfoPanelTransform.Find("middle/Text_attr").GetComponent<Text>();
        Text Text_info = m_AchieveInfoPanelTransform.GetComponentInChildren<ContentSizeFitter>(true).GetComponentInChildren<Text>(true);
