...
namespace StarForce
{
    public class ProcedureLaunch : ProcedureBase
    {
        ...
        {
            GameEntry.Setting.SetFloat(Constant.Setting.UIAsideTextSpeed, 70f);

            GameEntry.Setting.SetBool(Constant.Setting.UISpeakVolumeToggle, true);
            GameEntry.Setting.SetFloat(Constant.Setting.UISpeakVolume,0.7f);
            GameEntry.Setting.SetFloat(Constant.Setting.UISpeakTextSpeed, 6f);
        }
    }
}
