...
namespace StarForce
{
    public static partial class Constant
    {
        public static class Setting
        {
            ...
            public const string UISpeakVolumeToggle = "Setting.SpeakVolumeToggle";
            public const string UISpeakVolume = "Setting.SpeakVolume";
            public const string UIAsideTextSpeed = "Setting.AsideTextSpeed";
            public const string UISpeakTextSpeed = "Setting.SpeakTextSpeed";
        }
    }
}
