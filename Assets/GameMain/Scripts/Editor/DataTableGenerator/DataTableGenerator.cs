...
namespace StarForce.Editor.DataTableTools
{
    public sealed class DataTableGenerator
    {
        ...
        {
            return new DataTableProcessor(Utility.Path.GetRegularPath(Path.Combine(DataTablePath, dataTableName + ".txt")), Encoding.GetEncoding("UTF-8") /*Encoding.GetEncoding("GB2312")*/, 1, 2, null, 3, 4, 1);
        }
