...
namespace StarForce
{
    public static class EntityExtension
    {
        ...
        public static void ShowTreasure(this EntityComponent entityComponent, TreasureData data)
        {
            entityComponent.ShowEntity(typeof(Treasure), "Treasure", Constant.AssetPriority.TreasureAsset, data);
        }
